...
input int margen_close = 200;
input int take_prifit = 300;
...
void OnTick()
  {
      ...
      if (trade == true && atr_indicator >= 0.0017 && OrdersTotal() == 0 && last_tick.ask >= down + NormalizeDouble(margen_open*Point, Digits)){
      ...
      if (trade == true && atr_indicator >= 0.0017 && OrdersTotal() == 0 && last_tick.bid <= top - NormalizeDouble(margen_open*Point, Digits)){
